    ...
    <section className="py-20 sm:py-32 bg-bg px-4">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <span className="text-primary font-display uppercase tracking-widest text-sm font-semibold">Exquisite Pieces</span>
          <h2 className="text-4xl sm:text-5xl font-serif font-medium mt-4 text-base">Our Most Loved</h2>
        </div>
        
        <div className="flex overflow-x-auto tabs-scroll-hide gap-6 pb-8 snap-x snap-mandatory px-4 sm:px-0">
          {isLoading ? (
            Array.from({ length: 4 }).map((_, i) => (
              <div key={i} className="shrink-0 w-[280px] sm:w-[320px] snap-center">
