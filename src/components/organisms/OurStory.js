  ...
  return (
    <section className="py-24 sm:py-32 bg-bg overflow-hidden px-4">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
        ...
        >
          <span className="text-primary font-display uppercase tracking-widest text-sm font-semibold mb-4">Our Heritage</span>
          ...
          <p className="text-muted text-lg leading-relaxed mb-10 max-w-xl">
            Each piece at Aura Jewels is more than just an accessory; it is a
            story of passion and meticulous craftsmanship. Every design is
            brought to life with love, blending traditional techniques with modern aesthetics to create timeless elegance.
          </p>
          <Link href="/about">
